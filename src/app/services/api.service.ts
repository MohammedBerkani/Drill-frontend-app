...
export class ApiService {
  ...
  LoginOperator(data: any): Observable<Admin> {
    let url = `${this.baseUri}/drillOperator/login`;
  ...
  getSupAdmin(){
    let url = `${this.baseUri}/adminSup/Registration`;

    return this.http.get(url).pipe();  
  }
  readSupAdmin(id){
    console.log(id)
    let url = `${this.baseUri}/adminSup/${id}/Dashboard`;
  ...
  getOperators(){
    let url = `${this.baseUri}/drillSupervisor/:id/Dashboard/Operators`;
  ...
  findOperator(id) {
    console.log(id);
    let url = `${this.baseUri}/drillOperator/${id}/Dashboard/profile`;

    return this.http.get(url).pipe();
  }
  findSupervisor(id) {
    console.log(id);
    let url = `${this.baseUri}/drillSupervisor/${id}/Dashboard/profile`;

    return this.http.get(url).pipe();
  }
  deleteProject(id) {
    console.log('sqd', id);
    let url = `${this.baseUri}/admin/project/${id}/remove`;
    return this.http
  ...
  deleteAdmin(id) {
    console.log('sqd', id);
    let url = `${this.baseUri}/adminSup/admin/${id}/remove`;
    return this.http
      .patch(url, { headers: this.headers })
      .pipe(catchError(this.errorMgmt));
  }
  ...
  recievingProject(id) {
    console.log(id);
    let url = `${this.baseUri}/drillSupervisor/${id}/Project/`;
  ...
  UpdateAdminProfile(data: any, id): Observable<Admin> {
    let url = `${this.baseUri}/admin/${id}/Dashboard/profile`;
    console.log(data);
    return this.http.patch<Admin>(url, data).pipe();
  }
  UpdateAdminPassword(data: any, id){
    let url = `${this.baseUri}/admin/${id}/Dashboard/profile/password`;
    console.log(data);
    return this.http.patch(url, data).pipe();
  }
  
  UpdateSupervisorProfile(data: any, id): Observable<DrillSupervisor> {
    let url = `${this.baseUri}/drillSupervisor/${id}/Dashboard/profile`;
    console.log(data);
    return this.http.patch<Admin>(url, data).pipe();
  }
  UpdateSupervisorPassword(data: any, id){
    let url = `${this.baseUri}/drillSupervisor/${id}/Dashboard/profile/password`;
    console.log(data);
    return this.http.patch(url, data).pipe();
  }
  UpdateOperatorProfile(data: any, id): Observable<DrillOperator> {
    let url = `${this.baseUri}/drillOperator/${id}/Dashboard/profile`;
    console.log(data);
    return this.http.patch<Admin>(url, data).pipe();
  }
  UpdateOperatorPassword(data: any, id){
    let url = `${this.baseUri}/drillOperator/${id}/Dashboard/profile/password`;
    console.log(data);
    return this.http.patch(url, data).pipe();
  }
  UpdateSupAdminProfile(data: any, id): Observable<SupAdmin> {
    let url = `${this.baseUri}/adminSup/${id}/Dashboard/profile`;
    console.log(data);
    return this.http.patch<Admin>(url, data).pipe();
  }
  UpdateSupAdminPassword(data: any, id){
    let url = `${this.baseUri}/adminSup/${id}/Dashboard/profile/password`;
    console.log(data);
    return this.http.patch(url, data).pipe();
  }
